...
# create star_trek movie instance
star_trek = media.Movie("Star Trek Beyond",
    "The U.S.S. Enterprise crew explores the furthest reaches of uncharted "
    "space, where they encounter a new ruthless enemy, who puts them, and "
    "everything the Federation stands for, to the test.",
    "https://images-na.ssl-images-amazon.com/images/M/MV5BZDRiOGE5ZTctOWIxOS00MWQwLThlMDYtNWIwMDQwNzBjZDY1XkEyXkFqcGdeQXVyNjU0OTQ0OTY@._V1_SY500_CR0,0,337,500_AL_.jpg",  # NOQA
    "https://www.youtube.com/watch?v=XRVD32rnzOw"
    )

# create rogue_one movie instance
rogue_one = media.Movie("Rogue One",
    "The Rebel Alliance makes a risky move to steal the plans for the Death "
...
# create back_future movie instance
...
# create the_martian movie instance
